...
var Grid=require("./grid.js"),HUD=require("./hud.js"),Layer=require("./layer.js"),Legend=require("./legend.js"),DataImport=require("./data-import.js");try{new Uint8ClampedArray}catch(e){window.Uint8ClampedArray=Uint8Array}var defaultColorScale=d3.scale.quantize().domain([0,255]).range(["#a50026","#d73027","#f46d43","#fdae61","#fee08b","#d9ef8b","#a6d96a","#66bd63","#1a9850","#006837"]),GridMap=function(t,e){var o=this;this.rotateLatitude=0,this.rotateLongitude=0,this.container=d3.select(t);var i=d3.geo.graticule()(),n=this.container.node().getBoundingClientRect();this.width=0|n.width,this.height=0|n.height,this.layers=[],this.options=e||{},this.seaColor=this.options.seaColor||"rgba(21,98,180,.8)",this.graticuleColor=this.options.graticuleColor||"rgba(255,255,255,.3)",o.area=1;var r=d3.geo.transform({point:function(t,e,i){i>=o.area&&this.stream.point(t,e)}});this.dispatch=d3.geo.GridMap.dispatch,this.projection=this.options.projection||d3.geo.aitoff(),this.projection.translate([this.width/2,this.height/2]).clipExtent([[0,0],[o.width,o.height]]).precision(.1),this.canvas=this.container.append("canvas").style("position","absolute").style("top","0px").style("left","0px"),this.context=this.canvas.node().getContext("2d");var a=new HUD(this);this.colorScale=this.options.colorScale||defaultColorScale,this.options.zoomLevels||(this.options.zoomLevels=[1,2,4,8]),this.options.legend&&(this.options.context=a.context,this.options.colorScale=this.colorScale,this.legend=new Legend(this.options),this.legend.draw()),this.simplifyingPath=d3.geo.path().projection({stream:function(t){return r.stream(o.projection.stream(t))}}).context(this.context),this.path=d3.geo.path().projection(this.projection).context(this.context),this.init=function(){this.initEvents(),this.resize()},this.getGrid=function(){for(var t=0;t<this.layers.length;t++)if(this.layers[t].grid)return this.layers[t].grid},this.onMouseMove=function(){if(o.options.onCellHover||o.options.hud){var t=o.projection.invert(d3.mouse(this));if(t){var e=null,i=null,n=o.getGrid();n&&t[0]&&t[1]&&t[0]>-180&&t[0]<180&&t[1]>-90&&t[1]<90&&(e=n.coordinatesToCellId(t),i=n.getCell(e),i&&o.options.onCellHover&&o.options.onCellHover(i,e));var r=i/255;a&&e&&a.update(e,t,r),o.legend&&(o.legend.draw(),o.legend.highlight(r))}}},this.initEvents=function(){var t=150,e=d3.behavior.drag().on("dragstart",function(){}).on("drag",function(){o.rotateLongitude+=100*d3.event.dx/t,o.rotateLatitude-=100*d3.event.dy/t,o.projection.rotate([o.rotateLongitude,o.rotateLatitude]),o.drawAnimation()}).on("dragend",function(){o.draw()});if(!o.options.disableMouseZoom){var i=d3.behavior.zoom().on("zoomstart",function(){}).on("zoomend",function(){o.draw()}).on("zoom",function(e){t=d3.event.scale,o.area=2e4/t/t,o.projection.scale(t),o.drawAnimation()}).scale(t).scaleExtent([0,4e3]);this.container.call(i)}this.container.call(e),this.container.on("mousemove",o.onMouseMove),d3.select(window).on("resize",d3.geo.GridMap.dispatch.resize),d3.geo.GridMap.dispatch.on("resize."+o.container.attr("id"),function(){o.resize()})},this.drawWorld=function(){this.context.clearRect(0,0,this.width,this.height),this.context.beginPath(),this.path({type:"Sphere"}),this.context.fillStyle=this.seaColor,this.context.fill()},this.drawGeoJSONLayer=function(t){o.context.beginPath(),t.simplified?o.simplifyingPath(t.json):o.path(t.json),o.context.strokeStyle=t.options.strokeColor,o.context.lineWidth=.5,o.context.stroke(),o.context.fillStyle=t.options.fillColor,o.context.fill()},this.drawGrid=function(t){for(var e=this.context.getImageData(0,0,this.width,this.height),i=e.data,n=0;n<this.height;n++)for(var r=0;r<this.width;r++){var a=this.projection.invert([r,n]);if(a){var s=a[0],d=a[1];if(180>=s&&s>=-180&&90>=d&&d>=-90){var h=4*(r+this.width*n),c=~~(~~((90-d)/180*t.rows)*t.cols+(180+s)/360*t.cols+1);0!==t.data[4*c+3]&&(i[h]=t.data[4*c],i[h+1]=t.data[4*c+1],i[h+2]=t.data[4*c+2],i[h+3]=t.data[4*c+3])}}}o.context.putImageData(e,0,0)},this.drawGraticule=function(){this.context.beginPath(),this.path(i),this.context.closePath(),this.context.lineWidth=1,this.context.strokeStyle=this.graticuleColor,this.context.stroke()},this.drawLayers=function(t){for(var e=0;e<o.layers.length;e++){var i=o.layers[e],n=!t||i.options.renderOnAnimate;n&&(i.grid?o.drawGrid(i.grid):i.json&&("Topology"===i.json.type?o.drawTopoJSONLayer(i):o.drawGeoJSONLayer(i)))}},this._draw=function(){o.dispatch.drawStart(),o.drawWorld(),o.drawLayers(),o.drawGraticule(),o.dispatch.drawEnd()},this.drawAnimation=function(){var t=!0;o.drawWorld(),o.drawLayers(t),o.drawGraticule()};var s=function(t,e){var o=-1;return function(){o>-1&&window.clearTimeout(o),o=window.setTimeout(t,e)}};o.draw=s(o._draw,500),this._resize=function(){console.log("resizing ",o);var t=o.container.node().getBoundingClientRect();o.width=0|t.width,o.height=0|t.height,o.canvas.attr("width",o.width),o.canvas.attr("height",o.height),a&&a.resize(o.width,o.height),o.projection.translate([o.width/2,o.height/2]).clipExtent([[0,0],[o.width,o.height]]),o.draw()},this.resize=s(o._resize,200),this.panToCentroid=function(){return void console.debug("panToCentroid needs updating")},this.addLayer=function(t,e){var i=new Layer(e);if(t.constructor===ArrayBuffer){var n=DataImport.arrayBufferToGrid(t,e.gridSize,o.colorScale);i.grid=n}else if(t.constructor===Uint8Array||t.constructor===Uint8ClampedArray){var n=new Grid(t,e.gridSize);i.grid=n}else{if("Topology"===t.type){var r=e&&e.topojsonObject||t.objects[Object.keys(t.objects)[0]];t=topojson.feature(topojson.presimplify(t),r),i.simplified=!0}i.json=t}return o.layers.push(i),o.layers.sort(function(t,e){return t.options.zIndex-e.options.zIndex}),o.draw(),i},this.removeLayer=function(t){if("number"==typeof t)o.layers.splice(t,1);else for(var e=0;e<o.layers.length;e++)o.layers[e]===t&&o.layers.splice(e,1)},this.zoomTo=function(t){o.area=2e4/t/t,o.projection.scale(t),o.draw()},this.zoomIn=function(){o.options.zoomLevels.sort(function(t,e){return t-e});for(var t=o.projection.scale(),e=0;e<o.options.zoomLevels.length;e++)if(150*o.options.zoomLevels[e]>t)return void o.zoomTo(150*o.options.zoomLevels[e])},this.zoomOut=function(){o.options.zoomLevels.sort(function(t,e){return t-e});for(var t=o.projection.scale(),e=o.options.zoomLevels.length-1;e>=0;e--)if(150*o.options.zoomLevels[e]<t)return void o.zoomTo(150*o.options.zoomLevels[e])},this.init()};window.d3.geo.GridMap=GridMap,window.d3.geo.GridMap.dispatch=d3.geo.GridMap.dispatch||d3.dispatch("drawStart","drawEnd","resize");
